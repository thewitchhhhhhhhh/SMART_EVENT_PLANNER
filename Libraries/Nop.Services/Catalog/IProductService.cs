...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        Task<IPagedList<ProductAvailabilityDate>> GetAllProductAvailabilityDatesAsync(int productId = default,
            DateTime availableDate = default,
        ...
        Task<ProductAvailabilityDate> GetProductAvailabilityDateByIdAsync(int productAvailabilityId);
        Task InsertProductAvailabilityDateAsync(ProductAvailabilityDate productAvailability);
        Task UpdateProductAvailabilityDateAsync(ProductAvailabilityDate productAvailability);
        Task DeleteProductAvailabilityDateAsync(ProductAvailabilityDate productAvailability);
        Task<decimal> GetAvailabilitiesAverageAsync(Product product, bool? isBooked = default);
        ...
        Task<FoodType> GetFoodTypeByIdAsync(int foodTypeId);
        Task<IList<FoodType>> GetAllFoodTypeAsync();

        #endregion

        Task<IList<Product>> GetAllProductsByVendorIdAsync(int vendorId);
        Task<bool> IsHallAsync(Product product);
    }
}