...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        public virtual async Task<OrderItem> GetOrderItemByProductAvailabilityIdAsync(int productAvailabilityId)
        {
            return await _orderItemRepository.Table.FirstOrDefaultAsync(oi => oi.ProductAvailabilityDateId.GetValueOrDefault().Equals(productAvailabilityId));
        }
        ...
        public virtual async Task<IList<OrderItem>> GetOrderItemsAsync(int[] orderIds, bool? isNotReturnable = null, bool? isShipEnabled = null, int vendorId = 0)
        {
            if (orderIds == null)
                return new List<OrderItem>();
