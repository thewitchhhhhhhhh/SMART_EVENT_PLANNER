...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        Task<OrderItem> GetOrderItemByProductAvailabilityIdAsync(int productAvailabilityId);
        ...
        Task<IList<OrderItem>> GetOrderItemsAsync(int[] orderIds, bool? isNotReturnable = null, bool? isShipEnabled = null, int vendorId = 0);
